...

{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string seeListInput = Console.ReadLine().ToLower();
            ...
            if (seeList)
            {
                ...
                string addToListInput = Console.ReadLine().ToLower();
            ...
            while (cont)
            {
                ...
                Console.WriteLine();
                string contInput2 = Console.ReadLine().ToLower();
                cont = contInput2 == "redo";
            }
        }
    }
}